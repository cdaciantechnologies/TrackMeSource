           ...
           <div id="messagePrepender" class="rowx wrapper border-bottom white-bg page-heading">
             <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                    ...
                    <form>
                        <a href="geoFence_addNew.html" class="btn btn-primary">Add GeoFence</a>
                    </form>
                    </div>
                </div>
            </div>
...
<script>
  var fenceDetailsJSON = ${geoFenceDetailsJSON};
      $(document).ready(function () {
		...
		$('#errorMessage').fadeOut(5000);
          ...
          $('#entrydata').DataTable({
          	...
          	data:fenceDetailsJSON,
              columns:[
                       {data: "id",
                    	 "render": function ( data, type, full, meta ) {
                    	      return '<a href="editGeoFenceDetails.html?id='+data+'&isEdit=1"><i class="fa fa-pencil-square-o iconedit"  aria-hidden="true"></i></a>';}
                    	 },
                     {data: "id",
                        	 "render": function ( data, type, full, meta ) {
                       	      return '<a href="removeGeoFenceDetails.html?id='+data+'"><i class="fa fa-trash  icondelete" aria-hidden="true"></i></a>';}           	
